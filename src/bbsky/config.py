...
@click.pass_context
@ensure_config_dir
def create(context: click.Context, client_id: str, client_secret: str, redirect_uri: str, output: Path) -> None:
    """Create a new Blackbaud Sky API config."""
    config = SkyConfig(client_id, client_secret, URL(redirect_uri))
